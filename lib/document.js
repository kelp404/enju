  ...
  module.exports = Document = (function() {
    ...
    Document.define = function() {
      ...
      if (arguments.length === 2 && typeof arguments[0] === 'string' && typeof arguments[1] === 'object') {
        ...
        if ('_index' in arguments[0]) {
          this._index = arguments[0]['_index'];
          delete arguments[0]['_index'];
        }
        if ('_settings' in arguments[0]) {
          this._settings = arguments[0]['_settings'];
    ...
    Document.updateMapping = function() {
      ...
      putMapping = (function(_this) {
        return function() {
          var deferred, field, mapping, property, propertyName, ref, ref1;
          deferred = q.defer();
          mapping = {};
