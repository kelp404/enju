(function() {
  ...
  module.exports = Document = (function() {
    ...
    Document.prototype.save = function(refresh) {
      var args, dbFieldName, deferred, document, error, error1, property, propertyName, ref, ref1, ref2;
      if (refresh == null) {
        refresh = false;
      }
      ...
      this.constructor._es.index(args, (function(_this) {
        return function(error, response) {
          if (error) {
            deferred.reject(error);
            return;
