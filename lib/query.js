(function() {
  ...
  module.exports = Query = (function() {
    ...
    Query.prototype.hasAny = function() {
    ...
    Query.prototype.groupBy = function(field, args) {
      var allFields, dbField, deferred, obj, property, propertyName, queryObject, ref, ref1, ref2, ref3, ref4, ref5;
      if (args == null) {
        args = {};
      }
          ...
          aggs: {
            genres: {
              terms: {
                ...
                order: (
                  obj = {},
                  obj["_" + args.order] = args.descending ? 'desc' : 'asc',
                  obj
                )
              }
            }
    ...
    Query.prototype.compileQuery = function(queryCell) {
      ...
      @returns {object}
       */
      var bleachRegexCode, obj, obj1, obj2, obj3, obj4, obj5, obj6, obj7, obj8, obj9, value, x;
