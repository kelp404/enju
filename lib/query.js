(function() {
  ...
  module.exports = Query = (function() {
    ...
    Query.prototype.fetch = function(args) {
      ...
      this.documentClass._es.search({
        ...
        return function(error, response) {
          ...
          return deferred.resolve(items, total);
        };
      })(this));
      return deferred.promise;
    };
    ...
    Query.prototype.compileQueries = function() {
       ...
       */
      var elasticsearchQuery, i, index, isContainsEmpty, j, len, obj, obj1, queries, queryCell, ref, ref1, result, sort, subQuery;
      queries = [];
      sort = [];
      ...
      if (isContainsEmpty) {
        ...
        for (index = j = ref1 = this.queryCells.length - 1; j >= 0; index = j += -1) {
          if (this.queryCells[index].constructor === Array || this.queryCells[index].isIntersect) {
