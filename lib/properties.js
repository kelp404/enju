(function() {
  ...
  Property = (function() {
    ...
    function Property(args) {
      ...
      this.required = args.required, this.dbField = args.dbField, this.type = args.type, this.index = args.index, this.mapping = args.mapping;
  ...
  KeywordProperty = (function(superClass) {
    ...
    function KeywordProperty(args) {
      ...
      this.normalizer = args.normalizer;
